...
public class StatsController {
    ...
    @GetMapping("/stats")
    public List<StatsResponse> getStats(@NotEmpty @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime start,
                                        @NotEmpty @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime end,
